...
public class AccommodationFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        attractions.add(new Attraction(R.string.village_hotel_title, R.string.village_hotel_description, R.drawable.village_hotel));
        attractions.add(new Attraction(R.string.babou_hostel_title, R.string.babou_hostel_description, R.drawable.babou_hostel));
